    ...
    try {
      ...
      if (result.success) {
        toast.success("Account Created!", {
          description: "Your RecoverAI account has been created successfully.",
        });
        router.push("/");
      } else {
    ...
    <Card className="w-full max-w-md border-slate-200 dark:border-slate-800 shadow-lg">
      <CardHeader className="space-y-2 text-center pb-6 border-b border-slate-100 dark:border-slate-800">
        ...
        <CardDescription className="text-slate-600 dark:text-slate-400 text-sm">
          Register to safeguard and recover your smartphones
        </CardDescription>
      </CardHeader>
      <CardContent className="pt-6">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
